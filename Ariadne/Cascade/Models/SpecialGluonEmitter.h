// -*- C++ -*-
#ifndef ARIADNE5_SpecialGluonEmitter_H
#define ARIADNE5_SpecialGluonEmitter_H
//
// This is the declaration of the SpecialGluonEmitter class.
//
 ...
 *
 * @see \ref SpecialGluonEmitterInterfaces "The interfaces"
 * defined for SpecialGluonEmitter.
 */
class SpecialGluonEmitter: public EmitterBase {
...
private:
   ...
   */
  SpecialGluonEmitter & operator=(const SpecialGluonEmitter &);

};

}

#endif /* ARIADNE5_SpecialGluonEmitter_H */
