// -*- C++ -*-
//
// EventShapes.h is a part of ThePEG - Toolkit for HEP Event Generation
// Copyright (C) 1999-2007 Leif Lonnblad
//
// ThePEG is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef ThePEG_EventShapes_H
#define ThePEG_EventShapes_H
//
...
template <>
struct BaseClassTrait<ThePEG::EventShapes,1> {
...
template <>
struct ClassTraits<ThePEG::EventShapes>
  : public ClassTraitsBase<ThePEG::EventShapes> {
  /** Return a platform-independent class name */
  static string className() { return "ThePEG::EventShapes"; }
