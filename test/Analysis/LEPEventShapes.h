// -*- C++ -*-
#ifndef THEPEG_LEPEventShapes_H
#define THEPEG_LEPEventShapes_H
//
...
protected:
  ...
  /**
   * Function that creates a dataset using the specified binning
   * datavalue and error.
   */
  void dataSet(const std::string & path, const std::string & title,
      const std::vector<double> & bins, const std::vector<double> & y,
...
template <>
struct BaseClassTrait<ThePEG::LEPEventShapes,1> {
...
template <>
struct ClassTraits<ThePEG::LEPEventShapes>
  : public ClassTraitsBase<ThePEG::LEPEventShapes> {
  /** Return a platform-independent class name */
  static string className() { return "ThePEG::LEPEventShapes"; }
  /** Return the name(s) of the shared library (or libraries) be loaded to get
   *  access to the LEPEventShapes class and any other class on which it depends
   *  (except the base class). */
  static string library() { return "LEPEventShapes.so"; }
};
